...
- [UniformStreamlines.jl](https://github.com/antoniosgeme/UniformStreamlines.jl) : Evenly-spaced streamlines for 2-D, 3-D, and N-D vector fields in Julia, using the Jobard–Lefer algorithm. It supports `Plots.jl` and `Makie.jl`.
...
- [GR.jl](https://github.com/jheinen/GR.jl) : This module provides a Julia interface to the [GR framework](https://gr-framework.org/) graphics library, which is the default backend for `Plots.jl`.
