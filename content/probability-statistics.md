...
- [ISLR.jl](https://github.com/tndoan/ISLR.jl) : Julia version of "An Introduction to Statistical Learning: With Applications in R".
...
- [KissSmoothing.jl](https://github.com/francescoalemanno/KissSmoothing.jl) : Easily smooth your data with a `denoise()` function.
...
- [KernelDensity.jl](https://github.com/JuliaStats/KernelDensity.jl) : Kernel density estimators for continuous variable
...
- [DCCA.jl](https://github.com/johncwok/DCCA.jl) : Detrended cross-correlations coefficient analysis.
