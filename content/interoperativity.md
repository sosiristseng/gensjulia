...
- [libjulia-cl](https://github.com/cnuernber/libjulia-clj) : Julia bindings for Clojure JVM.
...
- [CondaPkg.jl](https://github.com/cjdoris/CondaPkg.jl) : Julia Pkg-like interface for the `conda` package manager.
...
- [PythonCall.jl](https://github.com/JuliaPy/PythonCall.jl) : Bringing Python and Julia code in harmony. You can also call Julia from Python.
...
- [ReduceLinAlg.j](https://github.com/JuliaReducePkg/ReduceLinAlg.jl) : A selection of functions that are useful in the world of linear algebra.
