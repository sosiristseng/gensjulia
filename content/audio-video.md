...
- [MusicTheory.jl](https://github.com/dpsanders/MusicTheory.jl) : provide a Julian interface for representing the objects and structures in ("Western") music theory (based on semitones).
...
- [PortAudio.jl](https://github.com/JuliaAudio/PortAudio.jl) : Julia interface API for the https://github.com/PortAudio/portaudio library for cross-platform access to audio devices.
