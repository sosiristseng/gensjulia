...
- [Nettle.jl](https://github.com/JuliaCrypto/Nettle.jl) : is a simple wrapper around [libnettle](https://www.lysator.liu.se/~nisse/nettle/), a cryptographic library, providing MD5, SHA1, SHA2 hashing and HMAC functionality, as well as AES encryption/decryption
...
- [Web3.jl](https://github.com/lambda-mechanics/Web3.jl): A module for Ethereum connectivity. Parse ABI files, encode/decode ABI data, and make [Ethereum ](https://github.com/ethereum) JSON-RPC calls: low-level calls, smart contract function calls and transactions.
